...
public class HateoasLinks {
    public void links(Object dto){
        if (dto instanceof UsuarioResponseDTO dto1) {
            ...
            dto1.add(linkTo(methodOn(UsuarioController.class).findAll(null)).withRel("FindAllUsers").withTitle("Busca todos os usuários cadastrados").withType("GET"));
            ...
            dto3.add(linkTo(methodOn(CategoriaController.class).findAll(null)).withRel("FindAllCategorys").withTitle("Busca todas as categoria adicionadas").withType("GET"));
